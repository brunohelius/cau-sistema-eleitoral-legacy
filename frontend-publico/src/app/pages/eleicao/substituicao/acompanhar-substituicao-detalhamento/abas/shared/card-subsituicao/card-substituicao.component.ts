...
@Component({
  selector: 'card-substituicao',
  templateUrl: './card-substituicao.component.html',
  styleUrls: ['./card-substituicao.component.scss']
})
export class CardSubstituicaoComponent implements OnInit {
