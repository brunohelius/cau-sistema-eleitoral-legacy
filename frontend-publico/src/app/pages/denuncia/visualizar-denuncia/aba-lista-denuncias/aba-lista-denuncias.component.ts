 ...
 */
@Component({
    selector: 'aba-lista-denuncias',
    templateUrl: './aba-lista-denuncias.component.html',
    styleUrls: ['./aba-lista-denuncias.component.scss']
})

export class AbaListaDenunciasComponent implements OnInit {
    ...
    @Input('acompanharDenuncia') acompanharDenuncia: string;
   ...
   */
    public visualizar(denuncia: any) {
        this.router.navigate(['denuncia', 'visualizar', denuncia.id_denuncia, 'tipoDenuncia', denuncia.id_tipo_denuncia]);
    }
