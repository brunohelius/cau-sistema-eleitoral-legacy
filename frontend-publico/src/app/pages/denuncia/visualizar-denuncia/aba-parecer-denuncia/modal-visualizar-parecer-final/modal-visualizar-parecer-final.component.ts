...
export class ModalVisualizarParecerFinalComponent implements OnInit {
  ...
  */
  public isProcedente() {
    return this.encaminhamentoParecerFinal.idTipoJulgamento == Constants.STATUS_JULGAMENTO_PROCEDENTE;
  }
  ...
  */
  public getSentenca() {
    ...
    return (this.encaminhamentoParecerFinal.idTipoSentencaJulgamento == Constants.ID_TIPO_SENTENCA_ADVERTENCIA ? 'LABEL_SENTENCA_ADVERTENCIA' :
      (this.encaminhamentoParecerFinal.idTipoSentencaJulgamento == Constants.ID_TIPO_SENTENCA_SUSPENSAO ? 'LABEL_SENTENCA_SUSPENSAO' :
        (this.encaminhamentoParecerFinal.idTipoSentencaJulgamento == Constants.ID_TIPO_SENTENCA_CASSACAO ? 'LABEL_SENTENCA_CASSACAO' :
          (this.encaminhamentoParecerFinal.idTipoSentencaJulgamento == Constants.ID_TIPO_SENTENCA_MULTA ? 'LABEL_SENTENCA_MULTA' :
            (this.encaminhamentoParecerFinal.idTipoSentencaJulgamento == Constants.ID_TIPO_SENTENCA_OUTRAS ? 'LABEL_SENTENCA_OUTRAS' : ''
            )
