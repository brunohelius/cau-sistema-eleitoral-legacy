...
/**
 * Classe de transferência associada ao 'ArquivoCalendario'.
 *
 * @package App\To
 * @author Squadra Tecnologia S/A.
 *
 * @OA\Schema(schema="ArquivoCalendario")
 */class ArquivoCalendarioTO
{
    /**
    ...
    /**
     * Fabricação estática de 'ArquivoCalendarioTO'.
     *
     * @param array|null $data
     *
     * @return ArquivoCalendarioTO
     */
    public static function newInstance($data = null)
    {
        $arquivoTO = new ArquivoCalendarioTO();
