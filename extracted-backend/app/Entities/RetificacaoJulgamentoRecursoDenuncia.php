<?php
/*
 * RetificacaoJulgamentoRecursoDenuncia.php
 * Copyright (c) CAU/BR.
 *
...
/**
 * Entidade de representação de 'RetificacaoJulgamentoRecursoDenuncia'.
 *
 * @ORM\Entity(repositoryClass="App\Repository\RetificacaoJulgamentoRecursoDenunciaRepository")
 * @ORM\Table(schema="eleitoral", name="TB_JULGAMENTO_RECURSO_DENUNCIA")
 *
 * @package App\Entities
 * @author Squadra Tecnologia S/A.
 */
class RetificacaoJulgamentoRecursoDenuncia extends Entity
{
    /**
     * @ORM\Id
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entities\JulgamentoRecursoDenuncia", inversedBy="retificacaoJulgamento")
     * @ORM\JoinColumn(name="ID_JULGAMENTO_RECURSO_RETIFICADO", referencedColumnName="ID_JULGAMENTO_RECURSO_DENUNCIA", nullable=true)
     *
     * @var JulgamentoRecursoDenuncia
     */
    private $julgamentoRetificado;
    ...
    public static function newInstance($data = null)
    {
        ...
        if ($data !== null) {
            ...
            $julgamentoRetificado = Utils::getValue('julgamentoRetificado', $data);
            if (!empty($julgamentoRetificado)) {
                $instance->setJulgamentoRetificado(JulgamentoRecursoDenuncia::newInstance($julgamentoRetificado));
            }
     ...
     */
    public function getJulgamentoRetificado()
    {
        return $this->julgamentoRetificado;
    }

    /**
     * @param $julgamentoRetificado
     */
    public function setJulgamentoRetificado($julgamentoRetificado)
    {
        $this->julgamentoRetificado = $julgamentoRetificado;
    }
