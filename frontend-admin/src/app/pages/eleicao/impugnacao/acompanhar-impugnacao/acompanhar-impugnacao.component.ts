 ...
 */
@Component({
    selector: 'acompanhar-impugnacao',
    templateUrl: './acompanhar-impugnacao.component.html',
    styleUrls: ['./acompanhar-impugnacao.component.scss']
})
export class AcompanharImpugnacaoComponent implements OnInit {
    public filtro: any;
    ...
    public getUrlVisualizar(id): Array<any> {
        return [`/eleicao/impugnacao/acompanhar-impugnacao/${id}`];
    }
