 ...
 */
@Component({
    selector: 'list-eleicao-chapa',
    templateUrl: './list-eleicao-chapa.component.html',
    styleUrls: ['./list-eleicao-chapa.component.scss']
})
export class ListEleicaoChapaComponent implements OnInit {
    public filtro: any;
    ...
    public getUrlVisualizar(id): Array<any> {
        return ['/eleicao', id, 'chapa', 'listar'];
    }
    ...
    */
    public getEleicaoPorFiltroAno() {
        ...
        let eleicoesByYear = this.eleicoes.filter(calendario => {
            return years.indexOf(calendario.eleicao.ano) != -1;
        });
