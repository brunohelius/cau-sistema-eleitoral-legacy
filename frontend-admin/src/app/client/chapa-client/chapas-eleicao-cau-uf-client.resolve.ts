...
/**
 * Classe resolve responsável pela busca de Chapas por CAUUF.
 *
...
export class ChapasEleicaoCauUfClientResolve implements Resolve<any> {
    ...
    public resolve(route: ActivatedRouteSnapshot): Observable<any> {
        ...
        return new Observable(observer => {
            this.chapaEleicaoService.getChapaPorCalendarioAndCauUf(id, idCauUf).subscribe(
                data => {
                    observer.next(data);
                    observer.complete();
                },
