...
@Component({
  selector: 'card-julgamento-final',
  templateUrl: './card-julgamento-final.component.html',
  styleUrls: ['./card-julgamento-final.component.scss']
})
export class CardJulgamentoFinalComponent implements OnInit {
