...
export class AtividadeSecundariaParamsDefinicaoEmailsResolve implements Resolve<any> {
    /**
    ...
    resolve(route: ActivatedRouteSnapshot): Observable<any> {
        ...
        return new Observable(observer => {
            this.atividadeSecundariaService.getParamsDefinicaoEmailsPorAtividadeSecundaria(id).subscribe(
                data => {
                    observer.next(data);
                    observer.complete();
                },
