...
@Injectable()
export class AcompanharImpugnacaoChapaClientResolve implements Resolve<any> {
    ...
    resolve(route: ActivatedRouteSnapshot): Observable<any> {
        return new Observable(observer => {
            this.acompanharImpugnacaoClientService.pedidosImpugnacaoUfResponsavelChapa().subscribe(
                data => {
                    observer.next(data);
                    observer.complete();
                },
