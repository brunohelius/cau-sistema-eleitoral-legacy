 ...
 */
@Component({
  selector: 'app-aba-lista-denuncia-estado',
  templateUrl: './aba-lista-denuncia-estado.component.html',
  styleUrls: ['./aba-lista-denuncia-estado.component.scss']
})
export class AbaListaDenunciaEstadoComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.denunciasRecebidas = this.route.snapshot.data["denunciasRecebidas"];
  ...
  public visualizar(idCauUf: any) {
    this.router.navigate(['denuncia', 'cauUf', idCauUf, 'listar']);
  }
