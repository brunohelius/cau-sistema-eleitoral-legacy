...
export class VisualizarJulgamentoRecursoSegundaInstanciaComponent implements OnInit {
  ...
  public isJulgamentoIndeferido(): boolean {
    return this.recursoSegundaInstancia.statusJulgamentoFinal.id === Constants.STATUS_JULGAMENTO_INDEFERIDO;
  }
  ...
  public isMostrarCadastrarSubstituicao(): boolean {
    return (
      ...
      this.chapa.isCadastradoSubstituicaoJulgamentoFinal == false &&
      this.recursoSegundaInstancia.indicacoes
    );
  }
   ...
   * Redireciona o usuário para a tela de visualizar pedido de substituicao
   */
  public fecharModalCadastrarSubstituicao(event: any) {
    this.redirecionarAposSalvamento.emit(event);
  }
