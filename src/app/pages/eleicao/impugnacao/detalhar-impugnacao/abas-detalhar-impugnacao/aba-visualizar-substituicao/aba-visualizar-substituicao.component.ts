 ...
 */
@Component({
    selector: 'aba-visualizar-substituicao',
    templateUrl: './aba-visualizar-substituicao.component.html',
    styleUrls: ['./aba-visualizar-substituicao.component.scss']
})

export class AbaVisualizarSubstituicaoComponent {
