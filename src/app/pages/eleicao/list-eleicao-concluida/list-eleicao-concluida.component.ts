 ...
 */
@Component({
    selector: 'list-eleicao-concluida',
    templateUrl: './list-eleicao-concluida.component.html',
    styleUrls: ['./list-eleicao-concluida.component.scss']
})
export class ListEleicaoConcluidaComponent implements OnInit {
    public filtro: any;
