...
@Component({
  selector: 'card-julgamento-recurso-segunda-instancia',
  templateUrl: './card-julgamento-recurso-segunda-instancia.component.html',
  styleUrls: ['./card-julgamento-recurso-segunda-instancia.component.scss']
})
export class CardJulgamentoRecursoSegundaInstanciaComponent implements OnInit {
