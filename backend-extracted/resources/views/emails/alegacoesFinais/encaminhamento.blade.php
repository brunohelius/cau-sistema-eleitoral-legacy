<div>
    ...
    <p>Encaminhamento: {{ $emailEncaminhamentoAlegacaoFinalTO->getEncaminhamento() }}</p>
    <p>Descrição do Encaminhamento: {!! $emailEncaminhamentoAlegacaoFinalTO->getDescricaoEncaminhamento() !!}</p>
