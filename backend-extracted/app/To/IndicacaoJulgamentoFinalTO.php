...
/**
 * Classe de transferência para a Indicação do Julgamento Final
 *
 * @package App\To
 * @author Squadra Tecnologia S/A.
 */
class IndicacaoJulgamentoFinalTO
{
    ...
    {
        $indicacaoJulgamentoFinalTO = new IndicacaoJulgamentoFinalTO();
     ...
     * Retorna uma nova instância de 'IndicacaoJulgamentoFinalTO'.
     *
     * @param $indicacaoJulgamentoFinal
     * @param bool $isResumo
     * @return IndicacaoJulgamentoFinalTO
     * @throws \Exception
     */
    public static function newInstanceFromEntity($indicacaoJulgamentoFinal, $isResumo = false)
    {
        $indicacaoJulgamentoFinalTO = new IndicacaoJulgamentoFinalTO();
