...
class JulgamentoDenunciaMail extends AtividadeSecundariaMail
{
    ...
    {
        return $this->view('emails.julgamentoDenuncia.inserirPrimeiraInstancia')->subject($this->email->getAssunto());
    }
}
