<?php
/*
 * RetificacaoJulgamentoDenuncia.php
 * Copyright (c) CAU/BR.
 *
...
/**
 * Entidade de representação de 'RetificacaoJulgamentoDenuncia'.
 *
 * @ORM\Entity(repositoryClass="App\Repository\RetificacaoJulgamentoDenunciaRepository")
 * @ORM\Table(schema="eleitoral", name="TB_JULGAMENTO_DENUNCIA")
 *
 * @package App\Entities
 * @author Squadra Tecnologia S/A.
 */
class RetificacaoJulgamentoDenuncia extends Entity
{
    /**
     * @ORM\Id
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entities\JulgamentoDenuncia", inversedBy="retificacaoJulgamento")
     * @ORM\JoinColumn(name="ID_JULGAMENTO_DENUNCIA_RETIFICADO", referencedColumnName="ID_JULGAMENTO_DENUNCIA", nullable=true)
     *
    ...
    public static function newInstance($data = null)
    {
        ...
        if ($data !== null) {
            ...
            $julgamentoRetificado = Utils::getValue('julgamentoDenuncia', $data);
            if (!empty($julgamentoRetificado)) {
                $instance->setJulgamentoRetificado(JulgamentoDenuncia::newInstance($julgamentoRetificado));
            }
