...
/**
 * Classe de transferência para a Indicação do Julgamento Segunda Instancia Substituição.
 *
 * @package App\To
 * @author Squadra Tecnologia S/A.
 */
class IndicacaoJulgamentoSegundaInstanciaSubstituicaoTO
{
    ...
    /**
     * Retorna uma nova instância de 'IndicacaoJulgamentoSegundaInstanciaSubstituicaoTO'.
     *
     * @param null $data
     * @return IndicacaoJulgamentoSegundaInstanciaSubstituicaoTO
     * @throws \Exception
     */
    public static function newInstance($data = null)
    {
        $indicacaoJulgamentoFinalTO = new IndicacaoJulgamentoSegundaInstanciaSubstituicaoTO();
