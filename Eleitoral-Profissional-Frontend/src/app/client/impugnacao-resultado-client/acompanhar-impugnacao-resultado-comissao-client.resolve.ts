...
export class AcompanharImpugnacaoResultadoComissaoClientResolve implements Resolve<any> {
    ...
    resolve(route: ActivatedRouteSnapshot): Observable<any> {
        return new Observable(observer => {
            this.acompanharImpugnacaoClientService.pedidosImpugnacaoComissao().subscribe(
                data => {
                    observer.next(data);
                    observer.complete();
                },
