...
export class ImpugnacaoResultadoImpugnanteResolve implements Resolve<any> {
    ...
    resolve(route: ActivatedRouteSnapshot): Observable<any> {
        ...
        return new Observable(observer => {
            this.impugnacaoResultadoClientService.getImpugnacaoComVerificacaoImpugnantePorId(id).subscribe(
                data => {
                    observer.next(data);
                    observer.complete();
                },
