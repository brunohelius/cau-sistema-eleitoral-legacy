...
export class CardPendencias implements OnInit {
  ...
  @Input() public dados: any = {};
    ...
    */
     ...
     */
    public redirecionaServico(servico: number, id: number, idTipoDenuncia?: number ) {
      switch(servico){
        ...
        case this.rotas.denuncia.id: window.open(`/denuncia/comissao/visualizar/${id}/tipoDenuncia/${idTipoDenuncia}`, '_blank');
        default: window.open('/')
      }
    }
