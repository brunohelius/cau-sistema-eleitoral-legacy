 ...
 */
@Component({
    selector: 'list-denuncias-comissao',
    templateUrl: './list-denuncias-comissao.component.html',
    styleUrls: ['./list-denuncias-comissao.component.scss']
})

export class ListDenunciasComissaoComponent implements OnInit {
