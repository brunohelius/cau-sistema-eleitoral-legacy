...
export class AcompanharImpugnacaoResultadoChapaClientResolve implements Resolve<any> {
    ...
    resolve(route: ActivatedRouteSnapshot): Observable<any> {
        return new Observable(observer => {
            this.acompanharImpugnacaoClientService.acompanharPorChapaDoProfissionalLogado().subscribe(
                data => {
                    observer.next(data);
                    observer.complete();
                },
