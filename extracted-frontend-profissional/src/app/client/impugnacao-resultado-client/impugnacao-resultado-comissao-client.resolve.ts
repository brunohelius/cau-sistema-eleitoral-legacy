...
export class ImpugnacaoResultadoComissaoResolve implements Resolve<any> {
    ...
    resolve(route: ActivatedRouteSnapshot): Observable<any> {
        ...
        return new Observable(observer => {
            this.impugnacaoResultadoClientService.getImpugnacaoComVerificacaoComissaoPorId(id).subscribe(
                data => {
                    observer.next(data);
                    observer.complete();
                },
