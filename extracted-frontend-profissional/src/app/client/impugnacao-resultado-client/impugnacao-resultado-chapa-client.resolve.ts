...
export class ImpugnacaoResultadoChapaResolve implements Resolve<any> {
    ...
    resolve(route: ActivatedRouteSnapshot): Observable<any> {
        ...
        return new Observable(observer => {
            this.impugnacaoResultadoClientService.getImpugnacaoComVerificacaoChapaPorId(id).subscribe(
                data => {
                    observer.next(data);
                    observer.complete();
                },
