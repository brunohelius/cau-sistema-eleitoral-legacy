...
export class DetalhamentoDenunciaComissaoCauUfResolve implements Resolve<any> {
    ...
    resolve(route: ActivatedRouteSnapshot): Observable<any> {
        ...
        return new Observable(observer => {
            this.denunciaService.getDetalhamentoDenunciaComissaoUfPorIdCauUf(idCauUf).subscribe(
                data => {
                    observer.next(data);
                    observer.complete();
                },
