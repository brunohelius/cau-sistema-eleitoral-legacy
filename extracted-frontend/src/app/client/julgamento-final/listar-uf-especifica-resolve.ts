...
@Injectable()
export class ListarUfEspecificaResolve implements Resolve<any> {
    ...
    resolve(route: ActivatedRouteSnapshot): Observable<any> {
        ...
        return new Observable(observer => {
            this.julgamentoFinalClientService.getDetalhamentoPorUfCalendario(idCalendario, idCauUf).subscribe(
                data => {    
                    observer.next(data);
                    observer.complete();
                },
