 ...
 */
@Injectable()
export class EleicoesImpugnacaoResultadoResolve implements Resolve<any> {
    ...
    resolve(route: ActivatedRouteSnapshot): Observable<any> {
        let filtro = { listaPedidosImpugnacaoResultado: true};
        return new Observable(observer => {
            this.calendarioClientService.getCalendariosPorFiltro(filtro).subscribe(
                data => {
                    observer.next(data);
                    observer.complete();
                },
