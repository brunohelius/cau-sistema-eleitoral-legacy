 ...
 */
@Component({
    selector: 'listar-eleicao-julgamento',
    templateUrl: './listar-eleicao-julgamento.component.html',
    styleUrls: ['./listar-eleicao-julgamento.component.scss']
})
export class ListarEleicaoJulgamentoComponent implements OnInit {
    public filtro: any;
    ...
    public getUrlVisualizar(id): Array<any> {
        return ['/eleicao','julgamento-final', 'acompanhar-ufs',id];
    }
