...
export class ModalVisualizarHistoricoPedidoSubstituicaoComponent implements OnInit {
  ...
  public inicializarPedidoSubstituicao(): void {
    ...
    this.pedido = {
      justificativa: this.pedidoSubstituicao.justificativa,
      arquivos: undefined,
      membrosSubstitutosDaChapa: this.pedidoSubstituicao.membrosSubstituicaoJulgamentoFinal.map(membroSubstituicao => {
          return {
      ...
      dataCadastro: moment.utc(this.pedidoSubstituicao.dataCadastro),
      titulo
    };
    if (this.pedidoSubstituicao.nomeArquivo) {
      this.pedido.arquivos = [
        {
          id: this.pedidoSubstituicao.id,
          nome: this.pedidoSubstituicao.nomeArquivo
        }
      ];
    }
  }
