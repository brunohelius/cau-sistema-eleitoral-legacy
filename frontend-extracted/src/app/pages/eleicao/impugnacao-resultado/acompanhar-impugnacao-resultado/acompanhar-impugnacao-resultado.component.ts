 ...
 */
@Component({
    selector: 'acompanhar-impugnacao-resultado',
    templateUrl: './acompanhar-impugnacao-resultado.component.html',
    styleUrls: ['./acompanhar-impugnacao-resultado.component.scss']
})
export class AcompanharImpugnacaoResultadoComponent implements OnInit {
    ...
    /**
     * Responsavel por inicializar o que e nescessario para o realisamento da pesquisa.
     */
    private inicializaPesquisa() {
    ...
    /**
     * Raliza a pesquisa com base no filtro.
     */
    public pesquisar() {
    ...
    /**
     * Redireciona a tela para o visualizar de acordo com seu 'id'.
     *
     * @param id
     */
    public getUrlVisualizar(id): Array<any> {
        return [`/eleicao/impugnacao-resultado/acompanhar-impugnacao/${id}`];
    }
