...
class EnviarEmailMembroIncluidoChapaJob extends Job
{
    /**
     * @var integer
     */
    ...
    /**
     * Criação de uma nova instância de EnviarEmailMembroIncluidoChapaJob.
     *
     * @param $idMembroChapa
     */
    ...
    {
        $this->getMembroChapaBO()->enviarEmailMembroChapaIncluido($this->idMembroChapa);
    }
