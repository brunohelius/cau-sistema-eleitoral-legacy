<?php
/*
 * EnviarEmailAlegacaoFinalCadastrarJob.php
 * Copyright (c) CAU/BR.
 *
...
class EnviarEmailAlegacaoFinalCadastrarJob extends Job
{
    ...
    /**
     * Criação de uma nova instância de EnviarEmailAlegacaoFinalCadastrarJob.
     *
    ...
    {
        $this->getAlegacaoFinalBO()->enviarEmailCadastroAlegacaoFinal($this->idEncaminhamentoDenuncia);
    }
