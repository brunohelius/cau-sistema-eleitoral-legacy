...
/**
 * Class ArquivoJulgamentoAdmissibilidadeTO
 * @package App\To
 *
 * @OA\Schema(schema="ArquivoJulgamentoAdmissibilidade")
 */
class ArquivoJulgamentoAdmissibilidadeTO
{
    /**
     ...
     * @return self
     */
    public static function newInstanceFromEntity(ArquivoJulgamentoAdmissibilidade $arquivoJulgamento = null)
    {
        $instance = new self;
